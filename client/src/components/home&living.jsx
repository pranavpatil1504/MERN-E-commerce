// client/src/components/HomeLiving.jsx
...
import homeliving from './data/homelivingdata';
...
const Homeliving = () => {
    ...
    useEffect(() => {
        setAddedToCart(homeliving.map(product => cartItems.some(cartItem => cartItem.id === product.id)));
    ...
    const filteredProducts = homeliving.filter(product =>
